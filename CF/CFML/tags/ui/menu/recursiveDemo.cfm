...
<cfmenu	type="horizontal">
	...
	<cfloop query="qMenus">
		<cfmenuitem display="#label#" href="#CGI.script_name#?id=#id#" name="sub_#parentId#_#id#">
			<cfset getSubmenus(menuData=qMenuData, parentId=id)>
		</cfmenuitem>
	</cfloop>
</cfmenu>


<cffunction name="getSubmenus" output="false" returntype="void">
	...
	<cfloop query="qSubs">
		<cfmenuitem display="#label#" href="#CGI.script_name#?id=#id#" name="sub_#parentId#_#id#">
			<cfset getSubmenus(menuData=menuData, parentId=id)>
		</cfmenuitem>
	</cfloop>
</cffunction>
