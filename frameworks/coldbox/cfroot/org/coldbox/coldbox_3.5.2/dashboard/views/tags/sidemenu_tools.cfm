...
<div class="sidemenu_toolbar">
	...
	<img src="includes/images/icons/print_icon.gif" align="absmiddle" id="btn_print" srcoff="includes/images/icons/print_icon.gif"
		 srcon="includes/images/icons/print_icon_on.gif" border="0" alt="Print!">&nbsp;<a href="javascript:window.print()" onMouseOver="rollover(btn_print)" onMouseOut="rollout(btn_print)">Print</a> <br>
	</div>

	<div class="sidemenu_toolbar_option">
	<img src="includes/images/icons/help_icon.gif" align="absmiddle" id="btn_help" srcoff="includes/images/icons/help_icon.gif"
		 srcon="includes/images/icons/help_icon_on.gif" border="0" alt="Help Tips!">
		 <a href="javascript:helpToggle()" onMouseOver="rollover(btn_help)" onMouseOut="rollout(btn_help)">Help</a><br>
	</div>

	<div class="sidemenu_toolbar_option">
	 <img src="includes/images/icons/logout.gif" id="btn_logout" srcoff="includes/images/icons/logout.gif"
 	  srcon="includes/images/icons/logout_on.gif" align="absmiddle" border="0" alt="Logout of the Dashboard">
