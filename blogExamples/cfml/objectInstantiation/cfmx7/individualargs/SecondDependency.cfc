...
<cfcomponent output="false">
	...
	<cffunction name="methodRequiringAllArgs" access="public" returntype="void" output="false">
		...
		<cfargument name="grouping4Arg1" type="string" required="true">
		<cfargument name="grouping4Arg2" type="string" required="true">
		<cfargument name="grouping4Arg3" type="string" required="true">
		<cfargument name="grouping4Arg4" type="string" required="true">
	</cffunction>
