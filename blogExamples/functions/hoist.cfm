<cfscript>
	function f(){												writeOutput("f() top: arguments: #arguments.varF#; unscoped: #varF#<br>");
		...
		local.varF	= "local_#i()#";							writeOutput("f() after local: arguments: #arguments.varF#; unscoped: #varF#<br>");
	...
	function g(){i();											writeOutput("g() top: arguments: #arguments.varG#; unscoped: #varG#<br>");
		...
		local.varG	= "local_#i()#";							writeOutput("g() after local: arguments: #arguments.varG#; unscoped: #varG#<br>");
	...
	function h(){												writeOutput("h() top: arguments: #arguments.varH#; unscoped: #varH#<br>");
		...
		local.varH	= "local_#i()#";							writeOutput("h() after local: arguments: #arguments.varH#; unscoped: #varH#<br>");
		return {arguments=arguments,local=local,varH=varH};
	}
