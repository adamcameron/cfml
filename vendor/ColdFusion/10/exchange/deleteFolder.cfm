...
<cftry>
	...
	<cfif qFolderInfo.recordCount>
		<cfexchangefolder connection="exchConn" action="findSubFolders" uid="#qFolderInfo.uid[1]#" name="qFolderInfo">
			<cfexchangefilter name="displayname" value="Adam Test Folder 2">
		</cfexchangefolder>
		<cfdump var="#qFolderInfo#" label="Folder to delete">
		<cfif qFolderInfo.recordCount>
			Deleting&hellip;
			<cfexchangefolder connection="exchConn" action="delete" uid="#qFolderInfo.uid[1]#" deletetype="hardDelete">
			deleted<br />
		<cfelse>
