component persistent=true indexable=true table="tbl_boostedlorem" {
	property name="id" type="string" fieldtype="id" generator="native" ormtype="string" column="lor_id" indexable=true indexstore=true;
	property name="mainText" column="lor_maintext" ormtype="text" indexable=true indexstore=true indexboost=5;
