...
<cfscript>
	...
	try {
		statusUpdate = application.twitterService.createUpdateString("#dateFormat(now(), 'yyyy-mm-dd')# #timeFormat(now(), 'HH:MM')# Untriaged ColdFusion 11 bug count: #bugs.recordCount#. List: http://bit.ly/1hzEmyj");
	...
	application.mailService.send(to="cfmlnotifier@gmail.com", subject="STATUS", body="countUntriagedCf11Bugs.cfm completed @ #now()#");
</cfscript>