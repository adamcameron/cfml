...
<cftry>
	...
	opened<br />
	Getting info&hellip;	
	<cfexchangefolder connection="exchConn" action="getInfo" uid="AAMkADhkZTdiZmI2LWU1ZDEtNDFmNC04MmE1LWI5NDQxY2Q0NTVkMgAuAAAAAADLiKvaRbnNT6pm2d9T2IWhAQAGaS3T1i8QS7nAISvzYw1vAAAAR2B+AAA=" name="qFolderInfo">
	complete<br />
	...
	<cfif qFolderInfo.recordCount>
		<cfexchangefolder connection="exchConn" action="findSubFolders" uid="#qFolderInfo.uid[1]#" name="qFolderInfo">
			<cfexchangefilter name="maxrows" value="1000">
		</cfexchangefolder>
		<cfdump var="#qFolderInfo#">
	<cfelse>
