...
(function() {
  jqapi.Sidebar = (function() {
    function Sidebar() {
      ...
      jqapi.events.on('window:resize', function(e, winEl) {
        var newHeight;
...
(function() {
  jqapi.Categories = (function() {
    function Categories() {
      ...
      this.el = $('#categories');
      self = this;
      jqapi.events.on('navigation:done', function() {
        return _this.hideLoader();
      });
      jqapi.events.on('search:empty', function() {
        return _this.el.show();
      });
      jqapi.events.on('search:done', function() {
        return _this.el.hide();
      });
      jqapi.events.on('categories:toggle', function(e, catEl) {
...
(function() {
  jqapi.Header = (function() {
    function Header() {
      ...
      self = this;
      jqapi.events.on('entry:done', function(e, entry) {
...
(function() {
  jqapi.Entries = (function() {
    function Entries() {
      ...
      jqapi.events.on('entries:load', function(e, entry) {
...
(function() {
  jqapi.Entry = (function() {
    function Entry() {
      ...
      jqapi.events.on('entry:load', function(e, slug) {
    ...
    Entry.prototype.loadContent = function(slug) {
      var _this = this;
      return $.getJSON("docs/entries/" + slug + ".json", function(data) {
        data.slug = slug;
...
(function() {
  jqapi.Search = (function() {
    function Search() {
      ...
      this.categories = [];
      this.lastTerm = '';
      jqapi.events.on('search:focus', function() {
      ...
      jqapi.events.on('search:clear', function() {
        _this.el.val('');
        return jqapi.events.trigger('search:empty');
      });
      jqapi.events.on('index:done', function(e, categories) {
    ...
    Search.prototype.triggerSearch = function() {
      ...
      if (term.length === 0) {
        ...
        this.lastTerm = term;
        return $.doTimeout('search', 200, function() {
...
(function() {
  jqapi.Navigate = (function() {
    function Navigate() {
      ...
      jqapi.events.on('navigate:up', function() {
        return _this.prevItem();
      });
      jqapi.events.on('navigate:down', function() {
        return _this.nextItem();
      });
      jqapi.events.on('navigate:enter', function() {
