ChartData = function(chartDesign){
	this.questions = {
		...
		q4 : [
			...
			{"values" : [16], text:"A reasonable but acceptable amount of rework needed", "background-color":chartDesign.seriesColours[3]},
		...
		q5 : [
			...
			{"values" : [54], text:"object.method(args) (eg: myArray.append(newElement))","background-color":chartDesign.seriesColours[6]}
		],
		q6 : [
			{"values" : [3], text:"It is removed", "background-color":chartDesign.seriesColours[7]},
			{"values" : [65], text:"It is simply stated that it is no longer the preferred way of doing something,\nbut otherwise will continue to be operational, but at some stage in the future it might be removed", "background-color":chartDesign.seriesColours[8]},
		...
		q7 : [
			...
			{"values" : [13], text:"It's a great idea", "background-color":chartDesign.seriesColours[3]}
		],
		q8 : [
			{"values" : [7], text:"The policy is correct", "background-color":chartDesign.seriesColours[4]},
			{"values" : [26], text:"The policy is reasonable, but perhaps not as important as Adobe seem to consider it", "background-color":chartDesign.seriesColours[5]},
			{"values" : [36], text:"The policy has caused stagnation in the language", "background-color":chartDesign.seriesColours[6]},
